        ...
        {notifications.map((notification) => {
          ...
          return (
            <div
              ...
              className={cn(
                "flex items-start gap-3 p-3 hover:bg-gray-50 dark:hover:bg-gray-800 cursor-pointer transition-colors",
            ...
            >
              <Avatar className="h-10 w-10 flex-shrink-0">
                ...
                <AvatarFallback>
                  {notification.from.name?.[0]?.toUpperCase() || "U"}
                </AvatarFallback>
              </Avatar>
              ...
              {isLoading ? (
                ...
                <div className="h-2 w-2 rounded-full bg-indigo-500 flex-shrink-0 mt-2" />
              ) : null}
            </div>
          );
        })}
